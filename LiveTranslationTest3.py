        ...
        try:
            ...
            if not data_queue.empty():
                ...
                for line in translation_to_en:
                    print(line)
                if translation_to_en != ['']:   #If there is no audio detected, then don't translate empty sound
                    ...
                    for sentence in sentences1:
                        print(sentence)
                        audio_array = generate_audio(sentence, history_prompt=speakerBarkLanguage)
