        ...
        try:
            ...
            if not data_queue.empty():
                ...
                if repr(detected_language) in lingua_to_mbart_languages:
                    ...
                    translation_to_en = tokenizer.batch_decode(
                    ...
                    print(
                        "Detected language not found in dictionary:", detected_language
                    )
                    translation_to_en = [""]
                ...
                if translation_to_en != [
                    ""
                ]:  # If there is no audio detected, then don't translate empty sound
                    text_prompt1 = translation_to_en[0]
                    ...
                    speakerBarkLanguage = "v2/en_speaker_6"
                    silence = np.zeros(
                    ...
                    for sentence in sentences1:
                        ...
                        audio_array = generate_audio(
                            sentence, history_prompt=speakerBarkLanguage
                        )
                        pieces += [audio_array, silence.copy()]
                    concatenated_audio = np.concatenate(pieces)

                    # save audio to disk
                    output_wav_path = "EnglishOutputTest.wav"
