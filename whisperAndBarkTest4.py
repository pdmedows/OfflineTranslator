...
detectedLanguage = BarkLanguages[f"{max(probs, key=probs.get)}"]
...
print(result.text)
mBartInput = combined_languages[detectedLanguage]
# translate Spanish to English
tokenizer.src_lang = mBartInput   # Enter input language code here
